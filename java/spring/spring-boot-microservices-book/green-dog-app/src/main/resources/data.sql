...
insert into propriedade(categoria,subcategoria,nome,valor,descricao) values ('DATA PROPERTIES','H2 Web Console','spring.h2.console.enabled','true','Enable the console');
insert into propriedade(categoria,subcategoria,nome,valor,descricao) values ('DATA PROPERTIES','H2 Web Console','spring.h2.console.path','/h2','Path at which the console will be available');
